                ...
                <div class="card border-0 shadow rounded-5">
                    <div class="card-body">
                        ...
                        <form action="" method="post" id="loginForm">
                            <input type="text" name="user" id="user" class="form-control my-4 py-2 rounded-4"
                                placeholder="Username">
                            <input type="password" name="pass" id="pass" class="form-control my-4 py-2 rounded-4"
